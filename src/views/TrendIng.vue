<template>
    <div class="flex flex-wrap justify-start items-start gap-5 w-5/6 min-h-screen text-lg bg-black p-8">
        ...
        <!-- recomendados -->
        <div class="flex justify-center w-full h-auto relative pl-2">
            ...
            <div class="flex items-center gap-1 min-w-auto h-80 pt-2 pb-4 overflow-scroll" v-if="trending && trending.length > 0">
                <CardView 
